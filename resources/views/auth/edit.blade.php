...
<div class="container my-container">
    <h3>Update</h3>
    <div class="main">
        <form action="{{route("table-update",["accounting"=>$accountings->id])}}"method="post" class="form-group">
            @method("PUT")
            @csrf
            <input class="form-control date" type="date" id="birthday" name="date">

            <select value="{{$accountings->type}}" name="type" id="my-select" class="form-select" aria-label="Default select example">
